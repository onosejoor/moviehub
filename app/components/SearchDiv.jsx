...
export default function SearchDiv({ data, route }) {
  const {
    id,
    adult,
    poster_path,
  ...
  return (
    <>
      <Link
        href={`/${route}/${id.toString()}`}
        className="hover:bg-gray-600 rounded-lg hover:text-gray-800 group/link transition-colors"
      >
        <div className=" h-fit flex gap-5 p-2 flex-wrap md:flex-nowrap sm:border-b-0  items-center ">
          <div className="h-[100px] sm:w-min w-full">
            <Img
              className={
                "rounded-xl h-full min-w-full sm:min-w-[150px] object-cover "
              }
              src={image}
              alt={title || name}
            />
          ...
          <div className="grid gap-3">
            ...
            <div className="flex gap-5">
              <div className="flex gap-2">
                ...
                <p className="text-base text-blue-100">{vote_average}</p>
              </div>
