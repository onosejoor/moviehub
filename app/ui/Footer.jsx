      ...
      <footer className="bg-blue-50 flex flex-col md:flex-row  justify-between items-center sm:ml-14 px-3 py-5 gap-5">
        <Link href={"/"}>
          <div className="flex items-center flex-col md:flex-row gap-3">
            ...
            <h3 className="font-rubik text-slate-900 text-xl">Moviehub </h3>
          </div>
        </Link>
        <div className="flex flex-col gap-3 items-center">
          <div className="flex gap-3">
            <Link href={"https://github.com/onosejoor"}>
              <svg
                className="fill-blue-950 hover:fill-blue-700 duration-100"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 30 30"
                width="30px"
                height="30px"
          ...
          <h3 className="text-gray-700 text-lg">©️ Moviehub {date}</h3>
        </div>
      </footer>
    </>
  );
